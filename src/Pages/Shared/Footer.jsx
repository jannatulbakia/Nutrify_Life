...
const Footer = () => {
    return (
        <div>
            <footer className="footer bg-gradient-to-r from-[#6F4F37] via-[#8E735B] to-[#A67C52] text-white p-12">
                {/* Center all sections and make them responsive */}
                <div className="flex flex-col md:flex-row justify-center items-center gap-12">
                    {/* Services Section */}
                    <div className="text-center bg-white bg-opacity-10 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                    ...
                    <div className="text-center bg-white bg-opacity-10 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                        ...
                        <div className="flex justify-center space-x-6">
                            <a
                                href="#"
                                className="hover:text-gray-300 transition-all duration-200 ease-in-out transform hover:scale-125">
